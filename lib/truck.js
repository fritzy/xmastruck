...
function Truck(game) {
    ...
    var bed = [ 20-center.x,160-center.y, 20-center.x,320-center.y, 300-center.x,320-center.y, 300-center.x,80-center.y ];
    ...
    /*for( var i = 0; i<bed.length-3; i+=2) {
        var shape = this.game.space.addShape(new cp.SegmentShape(chassis, cp.v(bed[i],bed[i+1]), cp.v(bed[i+2],bed[i+3])), 5);
        shape.setElasticity(0);
        shape.setFriction(.7);
        shape.group = 1;
        this.shapes.push(shape);
    }*/
    var shape = this.game.space.addShape(new cp.PolyShape(chassis, bed, cp.v(0,0)));
    shape.setElasticity(0);
    ...
    shape.group=1;
    this.shapes.push(shape);
    /*var shape = this.game.space.addShape(new cp.BoxShape(chassis, 720, 100));
    shape.setElasticity(0);
    shape.setFriction(.7);
    shape.group = 1;
    this.shapes.push(shape);*/
...
<<<<<<< HEAD
    this.constraints.push(this.game.space.addConstraint(new cp.GrooveJoint(chassis, wheel1, cp.v(180-center.x, 240-center.y), cp.v(180-center.x, 380-center.y), cp.v(0,0))));
    this.constraints.push(this.game.space.addConstraint(new cp.GrooveJoint(chassis, wheel2, cp.v(600-center.x, 240-center.y), cp.v(600-center.x, 380-center.y), cp.v(0,0))));
    this.constraints.push(this.game.space.addConstraint(new cp.DampedSpring(chassis, wheel1, cp.v(180-center.x, 240-center.y), cp.v(0,0), 100, 200, 15)));
    this.constraints.push(this.game.space.addConstraint(new cp.DampedSpring(chassis, wheel2, cp.v(600-center.x, 240-center.y), cp.v(0,0), 100, 200, 15)));
=======
    ...
    this.constraints.push(this.game.space.addConstraint(new cp.DampedSpring(chassis, wheel1, cp.v(180-center.x, 240-center.y), cp.v(0,0), 100, 20, 5)));
    this.constraints.push(this.game.space.addConstraint(new cp.DampedSpring(chassis, wheel2, cp.v(600-center.x, 240-center.y), cp.v(0,0), 100, 20, 5)));
>>>>>>> 6c9ef34bd6b63002ea3d04645c55fd72946e63ca
