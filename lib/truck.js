...
function Truck(game) {
    ...
    //wheel 1
    var wheel1  = this.game.space.addBody(new cp.Body(2, cp.momentForCircle(2,0,113,cp.v(0,0))));
    ...
    var wheel2 = this.game.space.addBody(new cp.Body(2, cp.momentForCircle(2,0,113,cp.v(0,0))));
    ...
    var bed = [ [ 20-center.x,160-center.y, 20-center.x,320-center.y, 30-center.x,320-center.y, 30-center.x,160-center.y ],
                [ 20-center.x,320-center.y, 300-center.x,320-center.y, 300-center.x,300-center.y, 20-center.x,300-center.y ],
                [ 300-center.x,320-center.y, 300-center.x,80-center.y, 290-center.x,80-center.y,  290-center.x,320-center.y ] ];
    var front = [ 315-center.x,165-center.y, 325-center.x,340-center.y, 700-center.x,325-center.y, 720-center.x,268-center.y, 708-center.x,207-center.y, 700-center.x,188-center.y, 440-center.x,95-center.y, 330-center.x,80-center.y ];
