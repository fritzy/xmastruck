...
function Truck(game) {
    ...
    this.constraints.push(this.game.space.addConstraint(new cp.GrooveJoint(chassis, wheel1, cp.v(180, 240), cp.v(180, 380), cp.v(0,0))));
    this.constraints.push(this.game.space.addConstraint(new cp.GrooveJoint(chassis, wheel2, cp.v(600, 240), cp.v(600, 380), cp.v(0,0))));
    this.constraints.push(this.game.space.addConstraint(new cp.DampedSpring(chassis, wheel1, cp.v(180, 240), cp.v(0,0), 100, 20, 5)));
    this.constraints.push(this.game.space.addConstraint(new cp.DampedSpring(chassis, wheel2, cp.v(600, 240), cp.v(0,0), 100, 20, 5)));
