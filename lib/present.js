...
function Present(game) {
    ...
    box = this.game.space.addBody(new cp.Body(5, cp.momentForBox(1, this.w, this.h)));
...
(function(){
    this.render = function(){
        ...
        this.game.renderer.ctx.rect(this.xoff, this.yoff, this.w, this.h);
        this.game.renderer.ctx.fillStyle = this.game.renderer.ctx.createPattern(
